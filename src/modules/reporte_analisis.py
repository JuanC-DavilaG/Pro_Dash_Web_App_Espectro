...
def AnalisDePortadoras(TipoFrec, datf, datg):
    ...
    # Primer ciclo para recorres todas las fecuencias ETIQUETA_2.
    for j in range(len(datg[TipoFrec])):
        
        #Obtenemos los valores de frecuencia y potencia de la primera frecuencia ETIQUETA_2.
        ...
        for i in range(PosNum, 0, -1):
            ...
            ##Evaluamos si la ETIQUETA_2 esta por delante de la concecion.
            elif valor - fr > 0:

                #Evaluamos si el limite superior de la concecion esta dentro de
                #los limetes de la ETIQUETA_2.
        ...
        for i in range(PosNum, len(datf)):
            ...
            #Evaluamos si la ETIQUETA_2 esta por detras de la concecion.
            elif valor - fr < 0:
