...
def Ocupacion(band, can, baja, alta, condiciones, SerPer, concecionado):
    ...
    # Leemos los datos
    tablas = "D:/Users/juan.davila/Documents/Proyectos py/Plotly/Proyecto Dash/app/assets/DataBase/tablas.csv"
    ...
    #         print('Espectro Protegido ', Protegido)
...
#            print('Sistema Móvil Maritimo ', Maritimo)
    ...
    #         print('Espectro Frontera ', Frontera)
    ...
    #     print('Segmentos CNAF: ', CNAF)

    #     print('Servicios CNAF: ', movil)
...
#   print('Espectro Concecionado ', concecionado)
    ...
    # arr, Libre, Protegido, Maritimo, Frontera, CNAF, movil
